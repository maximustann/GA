...
public class CecGAInitialization implements InitPop{
    ...
    // return the index of the suitable VM, if no VM is suitable, return null.
    ...
    // find the minimum vm type that can host this container, return the index of vmTypes
    ...
    private CecGAChromosome generateChromosome(){
        ...
        for(int i = 0; i < numOfContainer; ++i){
            // First step, find a suitable VM with First Fit
