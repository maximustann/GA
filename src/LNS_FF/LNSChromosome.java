...
public class LNSChromosome implements Cloneable{
    ...
    public LNSChromosome(int numOfServices,
                         double[] serviceCpu,
                         double[] serviceMem,
                         double[] serviceId,
                         double[] appId){
    ...
    @Override
    public LNSChromosome clone(){
        LNSChromosome newChromosome = new LNSChromosome(
                numOfServices,
                serviceCpu,
                serviceMem,
                serviceId,
