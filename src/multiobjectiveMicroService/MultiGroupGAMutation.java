 ...
 */
public class MultiGroupGAMutation implements Mutation {
    ...
    public MultiGroupGAMutation(MultiGroupGARearrangement rearrangement,
                                double[] containerCpu,
                                double[] containerMem,
    ...
    public void update(Chromosome individual, double mutationRate) {
        ...
        if(u > 0.5) { unpackCpuUtil((MultiGroupGAChromosome) individual); }
        else {unPackAvail((MultiGroupGAChromosome) individual); }
        mutateVmTypes((MultiGroupGAChromosome) individual);
    ...
    private void mutateVmTypes(MultiGroupGAChromosome individual){
...
//            } //end of enlarge
    ...
    public void unPackAvail(MultiGroupGAChromosome individual){


        individual.updateAppList();
        individual.sortPmAvailability();
        ...
        for(int i = 0; i < numOfPms; i++){
            total += pmList.get(i).getReplicaNum();
        }
        prob[0] = pmList.get(0).getReplicaNum() / total;
        for(int i = 1; i < numOfPms; i++){
            prob[i] = prob[i - 1] + (pmList.get(i).getReplicaNum()) / total;
        }
...
//        }
    ...
    public void unpackCpuUtil(MultiGroupGAChromosome individual){
