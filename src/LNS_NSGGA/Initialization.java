...
//    private int[] nonDominatedVmTypes = {6, 16, 19};
    ...
    public LNSChromosome init(){
        LNSChromosome chromosome = generateChromosome();
        return chromosome;
    }

    private LNSChromosome generateChromosome(){
        LNSChromosome chromosome = new LNSChromosome(
                numOfServices,
                serviceCpu,
                serviceMem,
                serviceId,
