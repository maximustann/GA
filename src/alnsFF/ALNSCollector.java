...
public class ALNSCollector extends DataCollector {
    private ArrayList<ALNSChromosome> resultData;
    private ArrayList<double[]> genTime;
    private double genStart;
    private double genEnd;

    public ALNSCollector(){
        super();
    ...
    public void collect(Object chromosome){
        resultData.add((ALNSChromosome) chromosome);
    }

    public ArrayList<ALNSChromosome> getResultData() {
        return resultData;
    }
